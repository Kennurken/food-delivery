...
| Reservations | **Shipped** (floor tables, overlap, kitchen confirm/seat) | `reservations` |
| Online payments | **Shipped** (Stripe Checkout; pending until Stripe says paid) | `payments.online` |
